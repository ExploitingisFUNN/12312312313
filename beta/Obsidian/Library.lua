...
function Library:MakeLine(Frame: GuiObject, Info)
    ...
    -- Add subtle gradient to lines for better visual appearance
    New("UIGradient", {
...
function Library:AddDraggableMenu(Name: string)
    ...
    -- Add texture and gradient effects to the background
    Library:AddBackgroundTexture(Holder)
    Library:AddBackgroundGradient(Holder, {
    ...
    -- Add enhanced border with inner shadow effect
    Library:EnhanceBorder(Holder, Library.CornerRadius - 1)
...
-- Add background texture and gradient utilities around line 386
function Library:AddBackgroundTexture(parent, props)
    props = props or {}
    ...
    local texture = New("ImageLabel", {
        ...
        BackgroundTransparency = 1,
        Image = props.TextureId or "rbxassetid://8091105823", -- Subtle noise texture
        ImageColor3 = props.TextureColor or Color3.fromRGB(255, 255, 255),
        ImageTransparency = props.TextureTransparency or 0.94,
        ScaleType = Enum.ScaleType.Tile,
        TileSize = props.TileSize or UDim2.new(0, 256, 0, 256),
        Size = UDim2.fromScale(1, 1),
...
function Library:AddBackgroundGradient(parent, props)
    props = props or {}
    
    -- Create gradient effect
    local gradient = New("UIGradient", {
        Color = props.GradientColor or ColorSequence.new({
            ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 255, 255)),
            ColorSequenceKeypoint.new(1, Color3.fromRGB(200, 200, 200))
        }),
        Transparency = props.GradientTransparency or NumberSequence.new({
            NumberSequenceKeypoint.new(0, 0.94),
            NumberSequenceKeypoint.new(1, 0.98)
        }),
        Rotation = props.Rotation or -35,
        Parent = parent
    })
...
function Library:EnhanceBorder(parent, cornerRadius)
    -- Add enhanced border with subtle inner shadow
    ...
    -- Add subtle inner shadow (as a frame)
    ...
    -- Add corner radius to the inner shadow
    ...
    -- Add gradient to inner shadow for better effect
    New("UIGradient", {
        Color = ColorSequence.new({
...
function Library:CreateWindow(WindowInfo)
    ...
    do
        ...
        -- Add texture and gradient effects to the background
        Library:AddBackgroundTexture(MainFrame)
        Library:AddBackgroundGradient(MainFrame)
        
        -- Enhanced border with subtle shadow
        Library:EnhanceBorder(MainFrame, WindowInfo.CornerRadius - 1)
        ...
        --// Sidebar Toggle State and Functionality \\--
        ...
        local function ToggleSidebar()
            ...
            -- Animate the sidebar and container
            ...
            -- Animate hamburger lines to X when sidebar is hidden
            if SidebarVisible then
                -- Return to hamburger state
            ...
            -- Resize tabs when container size changes
    ...
    function Window:AddTab(Name: string, Icon)
        ...
        do
            -- Tab Container Frame for separation line
            ...
            -- Separation line at bottom of tab
            New("Frame", {
            ...
            if Icon then
                -- Container for centered icon and text layout
    ...
    function Window:AddKeyTab(Name)
        ...
        function Tab:AddKeyBox(...)
            ...
            -- Add hover effects to Execute button
